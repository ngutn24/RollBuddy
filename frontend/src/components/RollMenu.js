    ...
    <div align="center" style={RollWindow}>
      <ButtonGroup>
        ...
        <DropdownButton
          id="roll_Condition"
          title={rollCondition}
          onSelect={handleSelectRollCondition}
      ...
      <ButtonGroup>
        <DropdownButton
          id="roll_Ability"
          title={rollAbility}
          onSelect={handleSelectRollAbility}
        ...
        <DropdownButton
          ...
          onSelect={handleSelectRollProficiency}
      ...
      {/* Have this display values used for calculation */}
      <h2>17</h2>
      <Button
        style={{
          margin: "1rem",
